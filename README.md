...
### Problem statements
- Setiap iris dalam kumpulan data termasuk dalam salah satu dari tiga kelas yang dipertimbangkan dalam model, jadi masalah ini adalah masalah klasifikasi tiga kelas. Keluaran yang diinginkan untuk satu titik data (sebuah iris) adalah spesies bunga dengan mempertimbangkan jenis-jenisnya.
